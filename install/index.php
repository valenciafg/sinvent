...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		if($database->create_database($_POST) == false) {
			...
			$message = $core->show_message('error',"The  second database tables could not be created, please verify your settings.");
      ...
      $redir = str_replace('install/','',$redir); 
			header( 'Location: ' . $redir . 'site/home/login' ) ;
		}
