...
//                $data['buildings_floors'] = $this->location_model->get_floors_buildings();
//                $data['office_floors_buildings'] = $this->location_model->get_office_floors_buildings();
//                echo $this->load->view('location/floor_details_view',$data);
////                $result_array['office_view'] = $this->load->view('location/office_details_view',$data,true);
//          //return $result_array;     
//                //echo $this->load->view('location/floor_details_view',$data);
        }
...
//        echo $floor_id;
//        exit;
        $data['building'] = $this->location_model->get_building_info($building_id);
//        print_r($data['floor']);
//        exit;
...
//        exit;
        //$data['first_floors'] = $this->location_model->get_first_floors();
        $this->load->view('location/building_edit', $data);
    }
...
//        exit;
    ...
    public function edits_building() {
